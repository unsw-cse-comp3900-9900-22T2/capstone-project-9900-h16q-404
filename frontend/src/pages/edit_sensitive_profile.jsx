...
export default function EditSensitiveProfile() {
  ...
  const FlexGenderPicker = () => {
    if (!gender) {
      return (
        <Radio.Group buttonStyle='solid' onChange={onGenderChange}>
  ...
  const onFinishSensitive = () => {
    ...
    axios
      .patch('http://127.0.0.1:5000/user/sensitive_details', values)
      .then((res) => res.data)
      .then((data) => {
      ...
      <Layout>
        ...
        >
          <div className='new_event'>
            ...
            <br />
            <h4>
              These details relates to attendance conditions. Please edit
              respectfully.
            </h4>
            <Space>
              Date of birth
            ...
            <br />
            <Space>
              Please upload your COVID-19 vaccination proof at here{' '}
              <PreUploadButton />
            </Space>
            <Space>
            ...
            <Space>
              Want to change normal details?{' '}
              <a href='/edit_profile'>Click here to edit general profile.</a>
            </Space>
          </div>
